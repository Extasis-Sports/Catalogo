document.addEventListener('DOMContentLoaded', () => {
    ...
    const discountThreshold30 = 12; // Umbral para el 30%
    const discountRate30 = 0.30;   // 30%

    const discountThreshold70 = 15; // Umbral para el 70% (nueva regla)
    const discountRate70 = 0.70;   // 70%
    ...
    function generateWhatsAppLink(name, quantity, total, discountApplied, discountAmount, appliedDiscountRate) {
        ...
        text += `\n¿Podrían confirmar mi pedido?`; // Añade un mensaje final
